    ...
    return (
        ...
        <nav className="mainnav">
          <ul className="mainnav-menu">
              ...
              <li className="mainnav-link"> <Link to="/search_vendor"> <i className="fas fa-search"></i>Search vendor and get details </Link></li>
              ...
              <li className="mainnav-link"> <Link to="/matsearch"> <i className="fas fa-search"></i> Search material and get details </Link></li>
          </ul>        
        </nav> 
